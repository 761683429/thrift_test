...
class Processor(Iface, TProcessor):
    ...
    def process_test(self, seqid, iprot, oprot):
        ...
        result = test_result()
        try:
            result.success = self._handler.test(args.laoren_js)
...
class test_args(object):
    ...
    def __init__(self, laoren_js=None,):
        self.laoren_js = laoren_js
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.laoren_js = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.laoren_js is not None:
            oprot.writeFieldBegin('laoren_js', TType.STRING, 1)
            oprot.writeString(self.laoren_js.encode('utf-8') if sys.version_info[0] == 2 else self.laoren_js)
            oprot.writeFieldEnd()
...
test_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'laoren_js', 'UTF8', None, ),  # 1
)
